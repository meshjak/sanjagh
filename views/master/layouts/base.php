...
<?php $this->beginPage() ?>
    ...
    <?php $this->beginBody() ?>
    <!-- BEGIN: Header-->
    <?= Yii::$app->view->renderFile('@app/views/master/layouts/header.php'); ?>
    <!-- END: Header-->

    <!-- BEGIN: Main Menu-->
    <?= Yii::$app->view->renderFile('@app/views/master/layouts/sidebar.php'); ?>
    <!-- END: Main Menu-->
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-left d-inline-block">ارائه شده در وب‌سایت <a href="https://www.rtl-theme.com" target="_blank">سنجاق</a></span><span class="float-right d-sm-inline-block d-none">ساخته شده با<i class="bx bxs-heart pink ml-50 font-small-3"></i></span>
